...
Africa <- RegionBreakdown[[1]] %>% tm_shape() + tm_fill(col = "Relationship",palette = c("purple","blue","grey","black","red","green")) + tm_layout(legend.width = 2)
Asia <- RegionBreakdown[[3]] %>% tm_shape() + tm_fill(col = "Relationship",palette = c("purple","blue","grey","black","red","green")) + tm_layout(legend.width = 2)
Europe <- RegionBreakdown[[4]] %>% tm_shape() + tm_fill(col = "Relationship",palette = c("purple","blue","grey","black","red","green")) + tm_layout(legend.width = 2)
NorthAmerica <- RegionBreakdown[[5]]  %>% tm_shape() + tm_fill(col = "Relationship",palette = c("purple","blue","grey","black","red","green")) + tm_layout(legend.width = 2)
Oceania <- RegionBreakdown[[6]]  %>% tm_shape() + tm_fill(col = "Relationship",palette = c("purple","blue","grey","black","red","green")) + tm_layout(legend.width = 2)
SouthAmerica <- RegionBreakdown[[8]]  %>% tm_shape() + tm_fill(col = "Relationship",palette = c("purple","blue","grey","black","red","green")) + tm_layout(legend.width = 2)
