...
Note that Canada withdrew in December 2012 however for this analysis we will examine the impact of the protocol being implemented as of 2005 and onwards. As well, since the emission data is yearly we will assume that the emissions for year 2005 were under the Kyoto Protocol.
